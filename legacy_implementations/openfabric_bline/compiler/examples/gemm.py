#!/usr/bin/env python3
"""ChipEnv example: explicit-SRAM GEMM."""
...
DEFAULT_OUTPUT_DIR = Path("tmp/gpdpu_compiler_chip_examples/gemm")
...
def build_env() -> ChipEnv:
    ...
    c_sram = env.sram_tensor_from_region("C", DFU3500_GEMM_REGIONS["C"])
