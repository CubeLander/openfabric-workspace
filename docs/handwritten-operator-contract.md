# second_wind 甲方手写算子职责清单

日期：2026-06-26

本文是 `second_wind` 重启后的第一个活文档落脚点。旧 OpenFabric/B-line 文档树已经
归档到 `legacy_implementations/openfabric_bline/`；当前新路线从
`simict3500final/` 的真实 vendor case 出发。
...
```text
legacy_implementations/openfabric_bline/docs/vendor_reference/case_authoring/operator-case-development.md
legacy_implementations/openfabric_bline/docs/vendor_reference/case_authoring/manual-vs-generated.md
legacy_implementations/openfabric_bline/docs/vendor_reference/case_authoring/elementwise-template-frontend-chain.md
legacy_implementations/openfabric_bline/docs/vendor_reference/cases/softmax/softmax-current-real-workflow.md
legacy_implementations/openfabric_bline/docs/vendor_reference/cases/gemm/gemm-template-fusion-task-reuse.md
legacy_implementations/openfabric_bline/docs/vendor_reference/common_oper/task-creation-generategraph-chain.md
legacy_implementations/openfabric_bline/docs/vendor_reference/common_oper/openfabric-vs-vendor-compile-flow-report.md
docs/vendor-workflow-evidence/csv-config-generator-notes.md
docs/vendor-workflow-evidence/gemm-copyt-pipeline-notes.md
docs/vendor-workflow-evidence/pe-operand-index-model.md
```
...
```text
cmake --build --preset vendor-cases-package
